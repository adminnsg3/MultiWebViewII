                                        ...
                                        <div class="form-line">
                                            <select class="form-control show-tick" id="content_user_id" name="content_user_id" data-live-search="true" data-show-subtext="true" required>
                                                ...
                                                foreach ($fetchUsers as $key) {
                                                    $content_user_selected = "";
                                                    if ($contentContent->content_user_id == $key->user_id) $content_user_selected = "selected='selected'";
                                                    ?>
                                                    <option <?php echo $content_user_selected; ?> data-subtext="(<?php echo $key->user_id ?>)" value="<?php echo $key->user_id ?>"><?php echo $key->user_username; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
